...
internal static partial class Export
{
    ...
    {
        Log.Verbose("[{Function}] {inContext} {intUtf8Country}", nameof(UPC_StreamingCurrentUserCountryFree), inContext, intUtf8Country);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outUtf8Country} {callback} {callbackData}", nameof(UPC_StreamingCurrentUserCountryGet), inContext, outUtf8Country, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outType} {callback} {callbackData}", nameof(UPC_StreamingDeviceTypeGet), inContext, outType, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outType} {callback} {callbackData}", nameof(UPC_StreamingInputGamepadTypeGet), inContext, outType, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outType} {callback} {callbackData}", nameof(UPC_StreamingInputTypeGet), inContext, outType, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outdelayMs} {callback} {callbackData}", nameof(UPC_StreamingNetworkDelayForInputGet), inContext, outdelayMs, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outdelayMs} {callback} {callbackData}", nameof(UPC_StreamingNetworkDelayForVideoGet), inContext, outdelayMs, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outdelayMs} {callback} {callbackData}", nameof(UPC_StreamingNetworkDelayRoundtripGet), inContext, outdelayMs, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outResolution} {callback} {callbackData}", nameof(UPC_StreamingResolutionGet), inContext, outResolution, callback, callbackData);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inResolution}", nameof(UPC_StreamingResolutionFree), inContext, inResolution);
        return -4;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {outType}", nameof(UPC_StreamingTypeGet), inContext, outType);
