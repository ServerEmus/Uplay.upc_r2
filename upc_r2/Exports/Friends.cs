...
internal static partial class Export
{
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inSearchStringUtf8} {inOptCallback} {inOptCallbackData}", nameof(UPC_FriendAdd), inContext, inSearchStringUtf8, inOptCallback, inOptCallbackData);
        return 0;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inUserIdUtf8} {inOptCallback} {inOptCallbackData}", nameof(UPC_FriendRemove), inContext, inUserIdUtf8, inOptCallback, inOptCallbackData);
        return 0;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inUserIdUtf8}", nameof(UPC_FriendCheck), inContext, inUserIdUtf8);
        return 0;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inUserIdUtf8} {checkPtr}", nameof(UPC_FriendCheck_Extended), inContext, inUserIdUtf8, checkPtr);
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inImageRGBA}", nameof(UPC_FriendListFree), inContext, inUserIdUtf8);
        return 0;
    }
    ...
    {
        Log.Verbose("[{Function}] {inContext} {inOptOnlineStatusFilter} {outFriendList} {inCallback} {inOptCallbackData}", nameof(UPC_FriendListGet), inContext, inOptOnlineStatusFilter, outFriendList, inCallback, inOptCallbackData);
