...
public class UserDependent
{
    ...
    {
        Log.Information(nameof(UPC_EmailGet), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_IdGet), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_IdGet_Extended), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_InstallLanguageGet), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_InstallLanguageGet_Extended), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_NameGet), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_NameGet_Extended), [inContext]);
    ...
    {
        Log.Information(nameof(UPC_TicketGet), [inContext]);
        if (UPC_Json.GetRoot().Account.UseTicket)
        {
            ...
            Log.Information(nameof(UPC_TicketGet), [ticket == null]);
    ...
    {
        Log.Information(nameof(UPC_TicketGet_Extended), [inContext]);
        if (UPC_Json.GetRoot().Account.UseTicket)
        {
            string? ticket = !string.IsNullOrEmpty(Main.GlobalContext.Config.Saved.ubiTicket) ? Main.GlobalContext.Config.Saved.ubiTicket : null;
            Log.Information(nameof(UPC_TicketGet_Extended), [ticket == null]);
    ...
    {
        Log.Information(nameof(UPC_UserAccountCountryGet), [inContext]);
