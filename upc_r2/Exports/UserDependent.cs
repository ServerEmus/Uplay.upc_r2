...
internal static partial class Export
{
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_EmailGet), inContext);
    ...
    public static int UPC_EmailGet_Extended(IntPtr inContext, , IntPtr emailptr)
    {
        ...
        Marshal.WriteIntPtr(idptr, 0, Marshal.StringToHGlobalAnsi(UPC_Json.Instance.Account.Email));
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_IdGet), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_IdGet_Extended), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_InstallLanguageGet), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_InstallLanguageGet_Extended), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_NameGet), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_NameGet_Extended), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_TicketGet), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_TicketGet_Extended), inContext);
    ...
    {
        Log.Verbose("[{Function}] {inContext}", nameof(UPC_UserAccountCountryGet), inContext);
