...
internal class User
{
    ...
    {
        Log.Information(nameof(UPC_UserGet), [inContext, inOptUserIdUtf8, outUser, inCallback, inCallbackData]);
    ...
    {
        Log.Information(nameof(UPC_UserFree), [inContext, inUser]);
    ...
    {
        Log.Information(nameof(UPC_UserPlayedWithAdd), [inContext, inUserIdUtf8List, inListLength]);
        return 0;
    }
    ...
    {
        Log.Information(nameof(UPC_UserPlayedWithAdd_Extended), [inContext, inUserIdUtf8List, inListLength, unk1, unk2]);
        return 0;
    }
}
